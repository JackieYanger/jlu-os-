...
public class FIFOListener implements ActionListener{
	static {
		 GUINM();		  
	...
	public static void GUINM() {
	 ...
	 public static DefaultTableModel model = new DefaultTableModel(infor,columnNames){
	  ...
	  public static DefaultTableModel model2 = new DefaultTableModel(infor_2,columnNames_2){
		 	 private static final long serialVersionUID=1L;
		 	 public boolean isCellEditable(int row,int column){
		 		 return false;
		 	 }
	...
	public static JFrame f = new JFrame("FIFO");
			    ...
			    for(int i=0,tps=5;i<10&&tps<25;i++,tps+=2) {
					...
					if(temp==-1) {
					 for(int m=0;m<4;m++) {
					    ...
					    System.out.println("发生缺页,被替换的页号"+cycle);					 					  
					    infor[6][tps]="缺页";
